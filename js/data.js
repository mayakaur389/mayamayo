const LESSONS = {
  ...
  2: {topic:"He/She/It is",questions:[
    {q:"He ___ a doctor",h:"वह एक डॉक्टर है",o:["are","is","am"],a:1,g:"He/She/It के साथ 'is' लगता है"},
  ...
  3: {topic:"We/They are",questions:[
    {q:"We ___ friends",h:"हम दोस्त हैं",o:["is","are","am"],a:1,g:"We/They के साथ 'are' लगता है"},
...
function loadState(){ let s = localStorage.getItem('mayaState'); if(s) state = JSON.parse(s); }
