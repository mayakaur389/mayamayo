const lessons = [
  ...
  },
  {
    ...
    questions: [
      {
        q: "I _ go to Delhi tomorrow.",
        options: ["will", "shall", "would"],
        answer: "will",
        hindi: "Main kal Delhi jaunga"
      },
      {
        q: "She _ come next week.",
        options: ["will", "shall", "would"],
        answer: "will",
        hindi: "Woh agle hafte aayegi"
      },
      {
        q: "They _ play tomorrow.",
        options: ["will", "would", "shall"],
        answer: "will",
        hindi: "Woh log kal khelenge"
      },
      {
        q: "We _ meet you soon.",
        options: ["will", "would", "shall"],
        answer: "will",
        hindi: "Hum jald hi tumse milenge"
      },
      {
        q: "He _ call you later.",
        options: ["will", "shall", "would"],
        answer: "will",
        hindi: "Woh tumhe baad me call karega"
      },
      {
        q: "You _ be happy.",
        options: ["will", "would", "shall"],
        answer: "will",
        hindi: "Tum khush rahoge"
      },
      {
        q: "I _ finish this work.",
        options: ["will", "shall", "would"],
        answer: "will",
        hindi: "Main ye kaam khatam karunga"
      },
      {
        q: "The train _ arrive on time.",
        options: ["will", "would", "shall"],
        answer: "will",
        hindi: "Train samay par aayegi"
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["my", "me", "mine"],
        answer: "my",
        hindi: "Ye meri kitab hai"
      },
      {
        q: "_ are playing.",
        options: ["They", "Them", "Their"],
        answer: "They",
        hindi: "Woh log khel rahe hain"
      },
      {
        q: "Give it to _.",
        options: ["I", "me", "my"],
      ...
      },
      {
        ...
        answer: "She",
        hindi: "Woh ek teacher hai"
      },
      {
        q: "I saw _ yesterday.",
        options: ["he", "him", "his"],
        answer: "him",
        hindi: "Maine use kal dekha"
      },
      {
        q: "_ house is big.",
        options: ["Our", "Us", "We"],
        answer: "Our",
        hindi: "Hamara ghar bada hai"
      },
      {
        q: "This pen is _.",
        options: ["mine", "me", "my"],
        answer: "mine",
        hindi: "Ye pen mera hai"
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["is", "are", "am"],
        answer: "is",
        hindi: "Woh ga rahi hai"
      },
      {
        q: "We _ going to school.",
        options: ["are", "is", "am"],
        answer: "are",
        hindi: "Hum school ja rahe hain"
      },
      {
        q: "He _ reading a book.",
        options: ["is", "are", "am"],
        answer: "is",
        hindi: "Woh kitab padh raha hai"
      },
      {
        q: "You _ studying now.",
        options: ["are", "is", "am"],
        answer: "are",
        hindi: "Tum abhi padh rahe ho"
      },
      {
        q: "The dog _ barking.",
        options: ["is", "are", "am"],
        answer: "is",
        hindi: "Kutta bhonk raha hai"
      },
      {
        q: "I _ writing a letter.",
        options: ["am", "is", "are"],
        answer: "am",
        hindi: "Main chitthi likh raha hoon"
      }
    ]
  }
];
