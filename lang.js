const translations = {
  ...
  portuguese_en: { btn_login: "Entrar", btn_language: "Escolher idioma", title: "Maya Didi", gupshup: "💬 Bate-papo com Maya", wrong: "❌ Praticar perguntas erradas", game: "🎧🎤 Jogo de ouvir e combinar", speaking: "🎤 Praticar fala", unit: "UNIDADE 1: BÁSICO - 1-30 DIAS", subtitle: "Escolha um dia e comece a aprender" },
...
window.currentLang = localStorage.getItem('lang') || 'hindi_en'; // GLOBAL VARIABLE
...
document.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => { changeLanguage(window.currentLang); }, 150);
});
